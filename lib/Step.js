  ...
  _createClass(Step, [{
    ...
    value: function render() {
      var _props2 = this.props,
          ...
          completeIcon = _props2.completeIcon,
      ...
      var stepContent
      if(active){
        stepContent = _react2.default.createElement('img', { src: activeIcon, alt: index + 1, style: {
          width: 24,
          height: 24
        } })
      }else if(completed) {
        stepContent = _react2.default.createElement('img', { src: completeIcon, alt: index + 1, style: {
          width: 18,
          height: 18
        } })
      }else {
        stepContent = _react2.default.createElement('img', { src: defaultIcon, alt: index + 1, style: {
          width: 18,
          height: 18
        } })
      }
